...
<template>
  <Head>
    <Title>درباره</Title>
    <Meta name="description" content="درباره Old Persian Games" />
  </Head>
  <h1
  ...
  >
    <p>
      ...
      <strong class="font-medium" style="text-shadow: #e73cff 0px 0px 20px"
        ...
        <span class="text-orange-500 dark:text-yellow-400">Games</span></strong
      >
    ...
    <ul>
      ...
      <li>
        همه‌ی کسانی که به هر نحوی دلگرمی دادن. شاید خودشون متوجه نباشن ولی برای
        ما کمک بزرگی بود. :-)
      </li>
