export default defineI18nConfig(() => ({
  ...
  messages: {
    en: {
      ...
      tgIntroUnderFiles:
        "You can also download the files from our Telegram channel:",
      pictures: "Pictures",
      ...
      underTable: "Showing <span class='font-medium'>{from}</span> to <span class='font-medium'>{to}</span> from <span class='font-medium'>{total}</span> rows",
      ...
      downloadOnlyFromTG:
        "It is possible to download this game only through the Telegram channel. Enter the Telegram channel {tgchannel} and search for the name of this game.",
      donation: "Donation",
    ...
    fa: {
      ...
      tgIntroUnderFiles:
        "با لینک‌های دانلود مشکلی دارید؟ از کانال تلگرامی‌مان هم می‌توانید دانلود کنید:",
      pictures: "تصاویر",
      joinCharacter: "، ",
      contribute: "مشارکت",
      ...
      underTable: "نمایش <span class='font-medium'>{from}</span> تا <span class='font-medium'>{to}</span> از <span class='font-medium'>{total}</span> ردیف",
      ...
      downloadOnlyFromTG:
        "امکان دانلود این بازی فقط از طریق کانال تلگرامی فراهم شده است. وارد کانال تلگرامی {tgchannel} شوید و نام این بازی را جستجو کنید.",
      donation: "حمایت مالی",
